# shelfscan Testing Guide

This document provides comprehensive information about testing in the shelfscan application.

## Overview

shelfscan uses a multi-layered testing approach with different tools for different types of tests:
