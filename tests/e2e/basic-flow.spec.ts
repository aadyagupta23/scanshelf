...
test.describe('shelfscan Basic Flow', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/');
  });

  test('should load the homepage successfully', async ({ page }) => {
    await expect(page).toHaveTitle(/shelfscan/);
    await expect(page.getByText('shelfscan')).toBeVisible();
  });
...
test.describe('shelfscan Mobile Experience', () => {
  test.use({ 
...
test.describe('shelfscan API Integration', () => {
...
test.describe('shelfscan Performance', () => {
...
test.describe('shelfscan Accessibility', () => {
...
test.describe('shelfscan Local Storage', () => {
